            ...
            for event in longpoll.listen():
                ...
                if event.type == VkEventType.MESSAGE_NEW:
                    ...
                    if event.from_me and text.startswith("/"):
                        ...
                        admin_cmds = ["/кик", "/спам", "/негатив", "/унегатив", "/клон", "/уклон", "/реакция", "/стопреакция", "/опубликовать", "/группы", "/игнор", "/уигнор", "/пригласить", "/дрвчат", "/рассылка", "/отпрчелу", "/пиар", "/стоппиар", "/гс", "/автозаявка", "/ии"]
